...
The product studio extends the navy surface into a large material-focused illustration stage. Orange controls separate image layers, with an adjacent component inspector and cream manufacturing section. This is a perspective illustration, not mechanical CAD. All nine researched products have self-hosted generated assets; their provenance and limits are documented in `VISUALS.md`. Factory profiles use geographic context and sourced relationships without fabricated site photographs.
